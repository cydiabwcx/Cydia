...
<!----------------------------------------------------------------------------测试-------------------------------------------------------------------------------------------->		
						...
						<div class="control-group">
							<label class="control-label"><?php _e('Gou mai');?></label>
							<div class="controls">
								<input type="text" name="Gou_mai_NAME" value="<?php if(defined("AUTOFILL_Gou_mai_NAME")){echo(htmlspecialchars(stripslashes(AUTOFILL_Gou_mai_NAME)));} ?>"/>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label"><?php _e('Gou mai dizhi');?></label>
							<div class="controls">
								<input type="text" name="Gou_mai" style="width: 400px;" value="<?php if(defined("AUTOFILL_Gou_mai")){echo(htmlspecialchars(stripslashes(AUTOFILL_Gou_mai)));} ?>"/>
