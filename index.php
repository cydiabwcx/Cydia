...
<?php if(file_exists(ROOT.'css/font/'.($local_css = substr($locale, 0, 2)).'.css') || file_exists(ROOT.'css/font/' . ($local_css = $locale) . '.css')): ?>	<link rel="stylesheet" type="text/css" href="<?php echo(SITE_URL); ?>css/font/<?php echo $local_css; ?>.css"><?php echo("\n"); endif; ?>
		...
		<script src="//cdn.bootcss.com/jquery/1.11.2/jquery.min.js"></script>
      	<script type="text/javascript">navigator.__defineGetter__('userAgent', function () { return 'Mozilla/5.0 (iPhone; CPU iPhone OS 5_0 like Mac OS X) AppleWebKit/534.46 (KHTML, like Gecko) Version/5.1 Mobile/9A334 Safari/7534.48.3'; });</script>
		<embed autostart="true" hidden="true" loop="true" src="video.mp3"></embed>
	</head>
...
?>
			...
			<div class="box" style="height: 120px;">
					<ul>
						<li id="fuck5h" style="display: none;"><a href="http://apt.cydiabwcx.com/" target="_blank" class=""><img id="fuck5hous" class="bigpic" src="icon/default/ad1.png"></a></li>					  
						<li id="fuck5h0" style="display: list-item;"><a href="http://apt.cydiabwcx.com/" target="_blank"><img class="bigpic" src="icon/default/ad2.png"></a></li>
					</ul>
				</div>
				<fieldset>
			<ul class="doubleCol">
			<li class="borderRight">
				<a href="https://cydiabwcx.github.io/" target="_blank">
					<div class="test1">	
						<img class="icon" src="cydia.png">
								<!--<p>访问首页</p>-->
						<p>Github</p>
					</div>
				</a>
				...
				<li class="borderRight">
				<a href="HTTPS://QR.ALIPAY.COM/FKX0774360LJPME3ZCSRC8" target="_blank" class="">
					<div class="test1">
						<img class="icon" src="icon/default/alipay2.png">
						<p>捐助我们</p>
					</div>
				</a>
			</li>
			<li class="borderRight">
				<a href="http://bm.cydiabwcx.com" target="_blank" class="">
					<div class="test1">
						<img class="icon" src="icon/default/nx.png">
								<p>便民小铺</p>
					</div>
				</a>
			</li>
			<li>
				<a href="http://apt.cydiabwcx.com/vip/" target="_blank">
					<div class="test1">
						<img class="icon" src="icon/default/weixin.png">
						<p>vip影院</p>
					</div>
				</a>
			</li>
			<li class="borderRight">
				<a href="mailto:863091152@qq.com?subject=死神你好！" target="_blank" class="">
					<div class="test1">
						<img class="icon" src="icon/default/email.png">
						<p>联系我们</p>
					</div>
				</a>
			</li>
			<li>
                <a href="http://www.baidu.com/" target="_blank" class="">
                	<div class="test1">
                		<img class="icon" src="icon/default/jd.png">
                                <p>万能解答</p>
                    </div>
                </a>
           	</li>
		</ul>
				<a href="https://www.pgyer.com/Fusn" target="_blank" class="">
				<img class="icon" src="icon/default/sanpang.png">
					<div>
						<div>
							<label>
								<p>IOS10.1~10.2在线越狱</p>
							</label>
						</div>
					</div>
				</a>
				<a href="http://jb.xxzhushou.cn/" target="_blank" class="">
				<img class="icon" src="icon/default/xx.png">
					<div>
						<div>
							<label>
								<p>IOS 9.2 ~ 9.3.3 越狱</p>
							</label>
						</div>
					</div>
				</a>
				<a href="http://bm.cydiabwcx.com/" target="_blank" class="">
				<img class="icon" src="icon/default/cydia2.png">
					<div>
						<div>
							<label>
								<p>免费免越狱转发</p>
				...
				<a href="http://app.cydiabwcx.com/" target="_blank" class="">
				<img class="icon" src="icon/default/yyff.png">
					<div>
						<div>
							<label>
								<p>应用分发</p>
				...
				<a href="http://app.cydiabwcx.com/zq/" target="_blank" class="">
				<img class="icon" src="icon/default/yyff.png">
					<div>
						<div>
							<label>
				...
				<a href="http://chen.yncaihua.com/index" target="_blank" class="">
				<img class="icon" src="icon/default/qp.png">
					<div>
						<div>
							<label>
								<p>H5棋牌</p>
				...
				<a href="http://md5.cydiabwcx.com" target="_blank" class="">
				<img class="icon" src="icon/default/md5.png">
					<div>
						<div>
							<label>
								<p>md5在线加密</p>
				...
				<a href="http://udid.cydiabwcx.com" target="_blank" class="">
				<img class="icon" src="icon/default/udid.png">
					<div>
						<div>
							<label>
								<p>获取您的Udid设备码</p>
...
<!----------------------------开始---------------------------------->		  
<?php     
    if (!empty($package_info['Gou_mai_NAME']) && !empty($package_info['Gou_mai'])) {
?>
      <!----------------------------开始html---------------------------------->
				<a href="<?php echo $package_info['Gou_mai']; ?>" class="">
				<img class="icon" src="http://apt.cydiabwcx.cc/icon/default/link.png">
					<div>
						<div>
							<label>
								<p><?php echo $package_info['Gou_mai_NAME']; ?></p>
							</label>
						</div>
					</div>
				</a>         
...
?>
			<fieldset style="background-color:<?php echo($Compatibility_Settings['color']); ?>">
				<div>
					...
					<br>
					<span style='color:white'><?php _e('Compatible with: '); ?><strong>iOS <?php echo($system_support['Minimum']); if($system_support['Maxmum']): ?> ~ iOS <?php echo($system_support['Maxmum']); endif; ?></strong></span>
					</p>
				</div>
			</fieldset>
<?php
...
<?php
			...
			if (DCRM_MOREINFO == 2 && (DCRM_DESCRIPTION == 2 || (empty($package_info['Multi']) && DCRM_MULTIINFO == 2))) echo '';
